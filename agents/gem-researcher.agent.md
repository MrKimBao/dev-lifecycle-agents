...
```yaml
- read_file      # read source files, PRD, knowledge docs
- search_codebase # semantic and grep search for patterns
```

# Output Files

`docs/plan/{plan_id}/research_findings_{focus_area}.yaml`
